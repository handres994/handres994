...
Soy un **Desarrollador Full Stack en formación**, apasionado por el mundo de la tecnología y el desarrollo web. Actualmente me encuentro adquiriendo experiencia profesional en el desarrollo de software, mientras continúo aprendiendo y fortaleciendo mis habilidades en **HTML, CSS, JavaScript, TypeScript, React, Node.js, Python, Java, Spring Boot y SQL**.
